...
askai_style: Callable[[str], str] = lambda lang='en': (
    f"<img src='{st.secrets['urls']['askai_en_gif']}' style='max-width:80px; width:auto; height:auto;'>"
    if lang == 'en' else
    f"<img src='{st.secrets['urls']['askai_pt_gif']}' style='max-width:80px; width:auto; height:auto;'>"
)
